...
xlabel('wind [m/s]') 
ylabel('height [m]') 
legend('x-axis wind', 'y-axis wind', 'z-axis wind', 'wind profile', 'Location', 'best')
...
legend('without wind', 'with wind','t = 0s','t = 10s','t = 20s','landing points', 'Location', 'best')
grid on
axis equal
...
set(gca,'FontSize',20)
xlabel('\rightarrow North [m]')
ylabel('\rightarrow height [m]')
